        ...
        return new Promise(async (resolve) => {
            const data_dataPoints = {
                ...
                4: { /****************************************** X3-Hybrid-G4 *****************************************/
                    ...
                    69: { name: 'data.yieldtotalOverflow', description: 'Inverter AC-Energy out total Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    72: { name: 'data.totalBatteryInputFromGridOverflow', description: 'Total Battery Input from Grid Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    75: { name: 'data.totalBatteryDischargeEnergyOverflow', description: 'Total Battery Discharge Energy Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    77: { name: 'data.totalBatteryChargeEnergyOverflow', description: 'Total Battery Charge Energy Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    81: { name: 'data.totalpvenergyOverflow', description: 'Total PV Energy Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    87: { name: 'data.totalFeedOverflow', description: 'Total Feed-in Energy Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    89: { name: 'data.totalConsumptionOverflow', description: 'Total Consumption Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    91: { name: 'data.feedinenergyOverflow', description: 'Feed in Energy Overflow', type: 'number', role: 'indicator.state' },
                    ...
                    93: { name: 'data.consumeenergyOverfow', description: 'Consume Energy Overflow', type: 'number', role: 'indicator.state' },
                ...
                8: { /****************************************** X1 Mini G4 *****************************************/
                    ...
                    0: { name: 'data.acvoltage', description: 'AC Voltage', type: 'number', multiplier: 0.1, unit: 'V', role: 'value.power' }, // 'AC Voltage'),
                    1: { name: 'data.outputcurrent', description: 'Output Current', type: 'number', multiplier: 0.1, unit: 'A', role: 'value.power' }, // Output Current
                    2: { name: 'data.gridfrequency', description: 'Grid Frequency', type: 'number', multiplier: 0.01, unit: 'Hz', role: 'value.power' }, // 'Grid Frequency'),
                    3: { name: 'data.acpower', description: 'Inverter AC-Power total', type: 'number', unit: 'W', role: 'value.power' }, // 'AC Power'),
                    4: { name: 'data.voltagedc1', description: 'PV1 Voltage', type: 'number', multiplier: 0.1, unit: 'V', role: 'value.power' }, // 'PV1 Voltage',
                    5: { name: 'data.voltagedc2', description: 'PV2 Voltage', type: 'number', multiplier: 0.1, unit: 'V', role: 'value.power' }, // 'PV2 Voltage',
                    8: { name: 'data.currentdc1', description: 'PV1 Current', type: 'number', multiplier: 0.1, unit: 'A', role: 'value.power' }, // PV1 Current
                    9: { name: 'data.currentdc2', description: 'PV2 Current', type: 'number', multiplier: 0.1, unit: 'A', role: 'value.power' }, // PV2 Current
                    10: { name: 'info.inverterStatus', description: 'Inverter Mode', type: 'string', role: 'text' }, // 'Inverter Mode')
                    13: { name: 'data.powerdc1', description: 'Inverter DC PV power MPPT1', type: 'number', unit: 'W', role: 'value.power' }, // 'PV1 Power'),
                    14: { name: 'data.powerdc2', description: 'Inverter DC PV power MPPT2', type: 'number', unit: 'W', role: 'value.power' }, // 'PV2 Power'),
                    19: { name: 'data.totalFeed', description: 'Total Feed-in Energy', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // 'Total Feed-in Energy'),
                    21: { name: 'data.yieldtoday', description: 'Inverter AC-Energy out Daily', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // Today's Energy
                    74: { name: 'data.feedinenergy', description: 'Feed in Energy', type: 'number', multiplier: 0.01, unit: 'kWh', role: 'value.power.consumption' }, // Feed in Energy
                    76: { name: 'data.consumeenergy', description: 'Consume Energy', type: 'number', multiplier: 0.01, unit: 'kWh', role: 'value.power.consumption' }, // Consume Energy
                },
            };
