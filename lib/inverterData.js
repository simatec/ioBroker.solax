        ...
        return new Promise(async (resolve) => {
            const data_dataPoints = {
                ...
                8: { /****************************************** X1 Mini G4 *****************************************/
                    ...
                    74: { name: 'data.feedinenergy', description: 'Feed in Energy', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // Feed in Energy
                    76: { name: 'data.consumeenergy', description: 'Consume Energy', type: 'number', multiplier: 0.1, unit: 'kWh', role: 'value.power.consumption' }, // Consume Energy
                },
            };
