        ...
        return new Promise(async (resolve) => {
            const data_dataPoints = {
                ...
                4: { /****************************************** X3-Hybrid-G4 *****************************************/
                    ...
                    125: { name: 'data.batteryCellVoltageMax', description: 'Battery Cell Voltage Max', type: 'number', multiplier: 0.01, unit: 'V', role: 'value.power' }, // Battery Cell Voltage Max,
                    126: { name: 'data.batteryCellVoltageMin', description: 'Battery Cell Voltage Max', type: 'number', multiplier: 0.01, unit: 'V', role: 'value.power' }, // Battery Cell Voltage Min,
                ...
                7: {
                    ...
                    8: { name: 'data.acpower1', description: 'AC Power 1', type: 'number', multiplier: 0.01, unit: 'W', role: 'value.power' }, // '': (8, 'W'), 
